...
import aboutItems1 from './aboutItems1.json';
import aboutItems2 from './aboutItems2.json';
import Collage from './collage';
import Image from 'next/image';

function About() {
  return (
    <section id="about" className="bg-cover relative bg-center overflow-hidden min-h-screen text-white ">
     <div className='w-full -z-10 h-full absolute'>
      ...
      {/* mobile */}
      <div className="md:hidden px-4 min-h-screen">
        <div className="flex py-3 gap-2 mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-9" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v2h-2zm0 4h2v6h-2z" />
          </svg>
          <h2 className='text-3xl font-bold'>TENTANG</h2>
        </div>
        <div className="flex flex-col mx-auto">
          <p className="text font-mont mb-4">Talangsari Fitness merupakan gym non-komersil yang dibuka sejak tahun 2019 oleh Widi Irwanto.</p>
          <div className="h-[420px] mb-4">
            <GallerySlider progressBarColor='bg-darkblu' imageItems={aboutItems1} />
          </div>
        </div>
        <div className="flex flex-col mx-auto">
          <div className="flex py-3 gap-2 mb-4">
            <svg className="w-9" viewBox="0 0 28 28" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className=" font-mont mb-4">Dengan lebih dari 100 member, Talangsari Fitness adalah komunitas yang siap membantu anda berubah.</p>
          <div className="h-[420px]">
            <GallerySlider progressBarColor='bg-darkblu' imageItems={aboutItems2} />
          </div>
        </div>
      </div>

      {/* desktop */}
      <div className="hidden py-5 w-10/12 gap-10 mx-auto md:flex flex-col">


        <div className="flex justify-evenly items-center ">
          <div className="text-xl flex-col flex  items-center lg:text-2xl text-center w-1/3 lg:w-1/4 font-mont">
            ...
            <p className="">Talangsari Fitness merupakan gym non-komersil yang dibuka sejak tahun 2019 oleh Widi Irwanto.</p>
          </div>
          <div className="w-1/2 lg:w-1/3">
            <Collage imageItems={aboutItems1} />
          </div>
        </div>
        ...
        <div className="hidden md:flex flex-col">
          <div className="flex items-center justify-evenly ">
            <div className="w-1/2">
              <Collage imageItems={aboutItems2} />
            </div>
            <div className="text-xl flex-col flex  items-center lg:text-2xl text-center w-1/3 lg:w-1/4 font-mont">
              <div className="flex py-3 gap-2 ">
                <div className="flex flex-col items-center gap-2">
              ...
              <p className="">Dengan lebih dari 100 member, Talangsari Fitness menjadi komunitas yang siap membantu anda berubah.</p>
            </div>
